...
<head>
    ...
    <style>
   .vs { height:40vh; }
    .content { background-image: url("./source/image/kv_type03.jpg"); }
                    ...
                    <form name="modify_form" id="modify_form" action="member_modify_pro.jsp" method="post" onsubmit="return form_check(this)">
						<table class="table">
							<tbody>
								...
								<tr>
									<th><label for="gender" class="lb">성별</label></th>
									<td colspan="2">
										<input type="button" value="남성" class="btn btn-outline-dark" onclick="init()"> &nbsp; &nbsp; &nbsp; &nbsp;
										<input type="button" value="여성" class="btn btn-outline-dark" onclick="init()">
									</td>
								</tr>
								<tr>
									<td colspan="2">
