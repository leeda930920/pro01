...
<body>
    <div class="container">
        ...
        <div class="content">
            <figure class="vs">
                <div class="img_box">
                    <h1 class="tit">THE LOHAS FOOD INFO</h1>
                </div>
            </figure>
            <section class="page" id="page1">
                <h2 class="page_tit">지속가능 식생활</h2>
            ...
            <section class="page" id="page4">
                <h2 class="page_tit">바른먹거리 캠페인</h2>
				<article class="grid3" style="width:1280px; margin:0 auto;">
